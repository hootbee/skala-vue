<template>
  <div class="app-shell">
    <nav class="app-nav" aria-label="주요 메뉴">
      ...
      <div class="nav-links"><RouterLink to="/">날씨 홈</RouterLink><RouterLink to="/about">서비스 소개</RouterLink></div>
    </nav>
    <RouterView />
  </div>
</template>
...
@media (max-width: 560px) { .app-nav { align-items: flex-start; flex-direction: column; gap: 12px; } }
</style>
