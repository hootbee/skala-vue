...
<style scoped>
.detail-view { width: min(820px, calc(100% - 40px)); margin: 0 auto; padding: 78px 0; color: #23445d; }
...
.detail-card { margin: 30px 0 24px; padding: 36px; border-radius: 24px; background: #fff; box-shadow: 0 16px 32px rgba(54, 97, 129, .1); }
...
.status { color: #668095; }
.back-link { display: inline-block; padding: 12px 16px; border-radius: 10px; color: #fff; background: #276fa3; text-decoration: none; }
</style>
